...
public class SkipIfNotEqualToVariableRegister implements Runnable {
    private final VariableRegisters variableRegisters;
    private final ProgramCounter programCounter;
    private final int x;
    private final int n;

    public SkipIfNotEqualToVariableRegister(VariableRegisters variableRegisters, ProgramCounter programCounter, int x, int n) {

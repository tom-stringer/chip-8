...
public class SkipIfVariableRegistersEqual implements Runnable {
    private final VariableRegisters variableRegisters;
    private final ProgramCounter programCounter;
    private final int x;
    private final int y;

    public SkipIfVariableRegistersEqual(VariableRegisters variableRegisters, ProgramCounter programCounter, int x, int y) {
